...
package com.google.photos.library.factories;
...
public class PhotosLibraryClientFactory {
  ...
  public static PhotosLibraryClient createClient(
    ...
    private static Credentials getUserCredentials(String credentialsPath, List<String> selectedScopes) throws IOException, GeneralSecurityException {
        try (InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream(credentialsPath));) {
            ...
            GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(GoogleNetHttpTransport.newTrustedTransport(),
                    JSON_FACTORY, clientSecrets, selectedScopes)
